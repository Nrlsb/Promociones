...
export default function Footer() {
    return (
        <footer className="bg-slate-900 text-white pt-20 pb-16 mt-20 relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-3 text-sm font-bold text-white/60">
                            ...
                            <li><Link href="/admin" className="hover:text-white transition-colors">Inicio</Link></li>
                        </ul>
                    </div>
